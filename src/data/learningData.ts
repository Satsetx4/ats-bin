...
export const flashcardsData: FlashcardItem[] = [
  ...
  },
  {
    "id": 6,
    "front": "ADiKSiMBa",
    "back": "Rumus 6 kata tanya emas: Apa, Di mana, Kapan, Siapa, Mengapa, dan Bagaimana untuk membedah seluruh isi bacaan!",
    "icon": "🧭",
...
export const miniGamesData = {
  ...
  pasangKataTanya: [
  {
    ...
    "desc": "Menanyakan kejadian atau benda"
  },
  {
    "qWord": "Siapa?",
    "targetMatch": "Orang atau tokoh yang terlibat",
    "desc": "Menanyakan pelaku atau orang"
  },
  {
    "qWord": "Kapan?",
    "targetMatch": "Waktu terjadinya peristiwa",
    "desc": "Menanyakan jam, hari, tanggal, atau suasana waktu"
  },
  {
    "qWord": "Di mana?",
    "targetMatch": "Tempat terjadinya peristiwa",
    "desc": "Menanyakan lokasi atau tempat"
  },
  {
    "qWord": "Mengapa?",
    "targetMatch": "Alasan atau penyebab peristiwa terjadi",
    "desc": "Menanyakan alasan atau latar belakang"
  },
  {
    "qWord": "Bagaimana?",
    "targetMatch": "Proses atau cara peristiwa terjadi",
    "desc": "Menanyakan langkah atau urutan kejadian"
  }
] as Game5W1HItem[]
};

export const questionBankData: QuestionItem[] = [
  {
    "id": 1,
    "category": "A",
